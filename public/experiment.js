...
window.addEventListener("load", () => {
    ...
    simplePlane.onReady(() => {
        ...
        document.getElementById("bg-wrap").addEventListener("mousemove", (e) => {
            handleMovement(e, simplePlane);
        });

        document.getElementById("content-wrap").addEventListener("mousemove", (e) => {
            handleMovement(e, simplePlane);
        });

        document.getElementById("bg-wrap").addEventListener("touchmove", (e) => {
            handleMovement(e, simplePlane);
        }, {
            passive: true
        });

        document.getElementById("content-wrap").addEventListener("touchmove", (e) => {
            handleMovement(e, simplePlane);
        }, {
            passive: true
        });
